...
fn main() {
    ...
    let res = DATA.lines()
        ...
        .filter_map(|o: (i32, i32, char, &str)| -> Option<bool> {
            let a = o.3.chars().nth(o.0 as usize - 1).unwrap() == o.2;
            let b = o.3.chars().nth(o.1 as usize - 1).unwrap() == o.2;
            if a != b { Some(true) } else { None }
        })
        .count();
...
static DATA: &str = r"9-10 m: mmmmnxmmmwm
6-8 w: wpwwhxnv
4-6 n: trwpnnnvq
